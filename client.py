...
def work():
    ...
    yield tornado.gen.Task(ch.queue_bind, queue='t1', exchange = 'test1', routing_key = 'test123')
    
    def consumer_callback(ch, method, params, body):
        ch.basic_ack(delivery_tag=method.delivery_tag)
        print(params, body)
    
    ch.basic_consume(consumer_callback, 't1')
